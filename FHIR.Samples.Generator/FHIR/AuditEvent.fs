...
let create (CR: CreateResource) =
        ...
        AuditEvent(
            ...
            Agent = L[
                        AuditEvent.AgentComponent(
                            ...
                            Extension = L [
                                Extension("https://fhir.patsoftware.com.au/useragent", FhirString("Mozilla/..."))
                                Extension("https://fhir.patsoftware.com.au/session-id-hash", FhirString("5d9474c0309b7ca09a182d888f73b37a8fe1362c"))
                            ]
                        )
                     ],
            ...
            Entity = L [
                        AuditEvent.EntityComponent(
                            Reference = ResourceReference("Practitioner/123"),
                            Detail = L[
                                        AuditEvent.DetailComponent(Type="newVersionId", Value= bytes("55"))
                            ]
                        )
                    ]
    )
    ...
    let query =
        AuditEvent(
            ...
            Subtype = L [
                Coding("http://hl7.org/fhir/restful-interaction", "search")
            ],
            ...
            Agent = L[
                        AuditEvent.AgentComponent(
                            ...
                            Network = AuditEvent.NetworkComponent(Address="1.2.3.4", Type = N AuditEvent.AuditEventAgentNetworkType.N2),
                            Extension = L [
                                Extension("https://fhir.patsoftware.com.au/useragent", FhirString("Mozilla/..."))
                                Extension("https://fhir.patsoftware.com.au/session-id-hash", FhirString("5d9474c0309b7ca09a182d888f73b37a8fe1362c"))
                            ]
    ...
    let update =
        AuditEvent(
            Type = Coding("http://hl7.org/fhir/audit-event-type", "rest"),
            Subtype = L [
                Coding("http://hl7.org/fhir/restful-interaction", "update")
            ],
            ...
            Agent = L[
                        AuditEvent.AgentComponent(
                            ...
                            Extension = L [
                                Extension("https://fhir.patsoftware.com.au/useragent", FhirString("Mozilla/..."))
                                Extension("https://fhir.patsoftware.com.au/session-log-id", FhirString("5d9474c0309b7ca09a182d888f73b37a8fe1362c"))
                            ]
                        )
                     ],
            Source = AuditEvent.SourceComponent(
            ...
            Entity = L [
                        AuditEvent.EntityComponent(
                            Reference = ResourceReference("Encounter/456")
                        )
                       ]
    )
