import { toFail, printf, toText, join } from "../fable-library.4.0.0-theta-018/String.js";
import { Result_Bind, Result_Map, FSharpResult$2 } from "../fable-library.4.0.0-theta-018/Choice.js";
import { Util_CachedDecoders, Util_Cache$1__GetOrAdd_43981464, CaseStrategy, Util_Casing_convert, ErrorReason } from "./Types.fs.js";
import { tryParse as tryParse_2 } from "../fable-library.4.0.0-theta-018/Guid.js";
import { toString as toString_12, FSharpRef } from "../fable-library.4.0.0-theta-018/Types.js";
import { tryParse as tryParse_3 } from "../fable-library.4.0.0-theta-018/Int32.js";
import { tryParse as tryParse_4, fromInt, fromNumber, fromBits, toNumber } from "../fable-library.4.0.0-theta-018/Long.js";
import { parse, fromInt32 } from "../fable-library.4.0.0-theta-018/BigInt.js";
import { tryParse as tryParse_5 } from "../fable-library.4.0.0-theta-018/Decimal.js";
import Decimal from "../fable-library.4.0.0-theta-018/Decimal.js";
import { toUniversalTime, tryParse as tryParse_6, minValue } from "../fable-library.4.0.0-theta-018/Date.js";
import { tryParse as tryParse_7, minValue as minValue_1 } from "../fable-library.4.0.0-theta-018/DateOffset.js";
import { tryParse as tryParse_8 } from "../fable-library.4.0.0-theta-018/TimeSpan.js";
import { map as map_4, defaultArg, some } from "../fable-library.4.0.0-theta-018/Option.js";
import { ofArray, toArray, map as map_1, length, singleton, append as append_1, tail as tail_1, head as head_1, isEmpty, ofSeq, empty, reverse, fold, tryLast, cons } from "../fable-library.4.0.0-theta-018/List.js";
import { int16ToString, numberHash, compare, comparePrimitives, defaultOf, uncurry, int32ToString } from "../fable-library.4.0.0-theta-018/Util.js";
import { map as map_2, tryFind, foldBack, fill, fold as fold_1 } from "../fable-library.4.0.0-theta-018/Array.js";
import { contains, fold as fold_2, toList, append, reverse as reverse_1 } from "../fable-library.4.0.0-theta-018/Seq.js";
import { getGenerics, getGenericTypeDefinition, makeTuple, getTupleElements, isTuple, isGenericType, parseEnum, getEnumValues, getEnumUnderlyingType, isEnum, getElementType, isArray, isUnion, makeRecord, getRecordElements, isRecord, fullName as fullName_1, makeUnion as makeUnion_1, getUnionCaseFields, getUnionCases, name as name_3, class_type } from "../fable-library.4.0.0-theta-018/Reflection.js";
import { empty as empty_1, map as map_3, tryFind as tryFind_1, add, ofSeq as ofSeq_1, ofList } from "../fable-library.4.0.0-theta-018/Map.js";
import { ofSeq as ofSeq_2 } from "../fable-library.4.0.0-theta-018/Set.js";
...
export const sbyte = (path) => ((value_2) => {
    ...
    if ((typeof value_3) === "number") {
        ...
        return (isFinite(value_1_1) && Math.floor(value_1_1) === value_1_1) ? (((-128 <= value_1_1) && (value_1_1 <= 127)) ? (new FSharpResult$2(0, [(value_1_1 + 0x80 & 0xFF) - 0x80])) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value was either too large or too small for " + name_1])]]))) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value is not an integral value"])]]));
    }
...
export const byte = (path) => ((value_2) => {
    ...
    if ((typeof value_3) === "number") {
        const value_1_1 = value_3;
        return (isFinite(value_1_1) && Math.floor(value_1_1) === value_1_1) ? (((0 <= value_1_1) && (value_1_1 <= 255)) ? (new FSharpResult$2(0, [value_1_1 & 0xFF])) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value was either too large or too small for " + name_1])]]))) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value is not an integral value"])]]));
    }
    else if ((typeof value_3) === "string") {
        let matchValue;
        let outArg = 0;
...
export const int16 = (path) => ((value_2) => {
    ...
    if ((typeof value_3) === "number") {
        const value_1_1 = value_3;
        return (isFinite(value_1_1) && Math.floor(value_1_1) === value_1_1) ? (((-32768 <= value_1_1) && (value_1_1 <= 32767)) ? (new FSharpResult$2(0, [(value_1_1 + 0x8000 & 0xFFFF) - 0x8000])) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value was either too large or too small for " + name_1])]]))) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value is not an integral value"])]]));
    }
    else if ((typeof value_3) === "string") {
        let matchValue;
        let outArg = 0;
...
export const uint16 = (path) => ((value_2) => {
    ...
    if ((typeof value_3) === "number") {
        const value_1_1 = value_3;
        return (isFinite(value_1_1) && Math.floor(value_1_1) === value_1_1) ? (((0 <= value_1_1) && (value_1_1 <= 65535)) ? (new FSharpResult$2(0, [value_1_1 & 0xFFFF])) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value was either too large or too small for " + name_1])]]))) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value is not an integral value"])]]));
    }
    else if ((typeof value_3) === "string") {
        let matchValue;
        let outArg = 0;
...
export const int = (path) => ((value_2) => {
    ...
    if ((typeof value_3) === "number") {
        const value_1_1 = value_3;
        return (isFinite(value_1_1) && Math.floor(value_1_1) === value_1_1) ? (((-2147483648 <= value_1_1) && (value_1_1 <= 2147483647)) ? (new FSharpResult$2(0, [~(~value_1_1)])) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value was either too large or too small for " + name_1])]]))) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value is not an integral value"])]]));
    }
    else if ((typeof value_3) === "string") {
        let matchValue;
        let outArg = 0;
...
export const uint32 = (path) => ((value_2) => {
    ...
    if ((typeof value_3) === "number") {
        const value_1_1 = value_3;
        return (isFinite(value_1_1) && Math.floor(value_1_1) === value_1_1) ? (((0 <= value_1_1) && (value_1_1 <= 4294967295)) ? (new FSharpResult$2(0, [value_1_1 >>> 0])) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value was either too large or too small for " + name_1])]]))) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value is not an integral value"])]]));
    }
    else if ((typeof value_3) === "string") {
        let matchValue;
        let outArg = 0;
...
export const int64 = (path) => ((value_2) => {
    ...
    if ((typeof value_3) === "number") {
        const value_1_1 = value_3;
        return (isFinite(value_1_1) && Math.floor(value_1_1) === value_1_1) ? (((toNumber(fromBits(0, 2147483648, false)) <= value_1_1) && (value_1_1 <= toNumber(fromBits(4294967295, 2147483647, false)))) ? (new FSharpResult$2(0, [fromNumber(value_1_1, false)])) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value was either too large or too small for " + name_1])]]))) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value is not an integral value"])]]));
    }
    else if ((typeof value_3) === "string") {
        let matchValue;
...
export const uint64 = (path) => ((value_2) => {
    ...
    if ((typeof value_3) === "number") {
        const value_1_1 = value_3;
        return (isFinite(value_1_1) && Math.floor(value_1_1) === value_1_1) ? (((toNumber(fromBits(0, 0, true)) <= value_1_1) && (value_1_1 <= toNumber(fromBits(4294967295, 4294967295, true)))) ? (new FSharpResult$2(0, [fromNumber(value_1_1, true)])) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value was either too large or too small for " + name_1])]]))) : (new FSharpResult$2(1, [[path_1, new ErrorReason(1, [name_1, value_1_1, "Value is not an integral value"])]]));
    }
    else if ((typeof value_3) === "string") {
        let matchValue;
        let outArg = fromInt(0);
...
export function andMap() {
    return (d) => ((d_1) => ((path) => ((value_1) => map2((arg, func) => func(arg), uncurry(2, d), uncurry(2, d_1), path, value_1))));
}
...
function makeUnion(extra, caseStrategy, t, name, path, values) {
    ...
    if (uci != null) {
        const uci_1 = uci;
        const decoders = map_2((fi) => autoDecoder(extra, caseStrategy, false, fi[1]), getUnionCaseFields(uci_1), null);
...
function autoDecodeRecordsAndUnions(extra, caseStrategy, isOptional, t) {
    ...
    let decoder;
    if (isRecord(t, true)) {
        const decoders = map_2((fi) => [Util_Casing_convert(caseStrategy, name_3(fi)), autoDecoder(extra_1, caseStrategy, false, fi[1])], getRecordElements(t, true), null);
...
function autoDecoder(extra, caseStrategy, isOptional, t) {
    ...
    if (matchValue == null) {
        if (isArray(t)) {
            ...
            if (isTuple(t)) {
                const decoders = map_2((t_8) => autoDecoder(extra, caseStrategy, false, t_8), getTupleElements(t), null);
                ...
                if (fullname_1 === "Microsoft.FSharp.Core.FSharpOption`1[System.Object]") {
                    return (decoder_13 = autoDecoder(extra, caseStrategy, true, getGenerics(t)[0]), (path_15) => ((value_22) => option(uncurry(2, decoder_13), path_15, value_22)));
                }
                else if (fullname_1 === "Microsoft.FSharp.Collections.FSharpList`1[System.Object]") {
                    return (decoder_14 = autoDecoder(extra, caseStrategy, false, getGenerics(t)[0]), (path_16) => ((value_23) => list(uncurry(2, decoder_14), path_16, value_23)));
                }
                else if (fullname_1 === "System.Collections.Generic.IEnumerable`1[System.Object]") {
                    return (decoder_15 = autoDecoder(extra, caseStrategy, false, getGenerics(t)[0]), (path_17) => ((value_24) => seq(uncurry(2, decoder_15), path_17, value_24)));
                }
                    ...
                    let d_20;
                    const decoders_1 = ofArray([(path_18) => ((value_25) => autoObject2(uncurry(2, keyDecoder), uncurry(2, valueDecoder), path_18, value_25)), (decoder_16 = tuple2(uncurry(2, keyDecoder), uncurry(2, valueDecoder)), (path_19) => ((value_26) => list(uncurry(2, decoder_16), path_19, value_26)))]);
                    d_20 = ((path_20) => ((value_27) => oneOf(decoders_1, path_20, value_27)));
                    return (path_21) => ((value_29) => map(toMap, uncurry(2, d_20), path_21, value_29));
                }
                    ...
                    return (path_22) => ((value_30) => {
                        const matchValue_7 = array(uncurry(2, decoder_17), path_22, value_30);
