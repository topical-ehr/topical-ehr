...
export class CandleLiteWrapper {
    ...
    async Request(method, path, body) {
        ...
        let resp = server.HandleRequest(method, "/fhir/" + path, "/fhir/", body, getHeader, setHeader);
        console.log(resp);
        return { status: resp.Status, body: resp.BodyString, headers };
    }
    async Exists() {
    ...
    async LoadDbSnapshot(url) {
        ...
        const rc = sqlite3.capi.sqlite3_deserialize(db.pointer, "main", //this.dbFilename,
        p, arrayBuffer.byteLength, arrayBuffer.byteLength, sqlite3.capi.SQLITE_DESERIALIZE_FREEONCLOSE
        // Optionally:
...
//# sourceMappingURL=CandleLiteWorker.js.map