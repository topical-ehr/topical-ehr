...
// URL schemas
let patFhirUrl s = "https://metadata.patsoftware.com.au/v3.0/FHIR/" + s
...
let guidToQuestionDataElementUrl (guid:Guid) =
    patFhirUrl "question/DataElement/uuid/" + guid.ToString()
...
module KnownUrls =
    let codesystemOrdinalValue = "http://hl7.org/fhir/StructureDefinition/codesystem-ordinalValue"
    let codesystemConceptOrder = "http://hl7.org/fhir/StructureDefinition/codesystem-conceptOrder"
    let cqifLibrary = "http://hl7.org/fhir/StructureDefinition/cqif-library"
