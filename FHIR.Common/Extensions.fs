...
module PatExtensions =
    ...
    module Urls =
        ...
        let PRACTICE_SOFTWARE_INTERNAL_ID =
            urlFor "source-practice-software-InternalId"

        let PRACTICE_SOFTWARE_CONTACT_ID =
            urlFor "source-practice-software-ContactId"

        let PRACTICE_SOFTWARE_RECORD_ID =
            urlFor "source-practice-software-RecordId"
        ...
        module QuestionnaireResponse =
            ...
            let AutomatchedReason =
                urlFor "Questionnaire-Response-Automatched-Reason"
        ...
        let AlliedHealthEPCMedicareVisitCount =
            urlFor "Allied-Health-EPC-Medicare-Visit-Count"
